                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="product_name"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>商品类别</label>
                                    <div class="mws-form-item small">
                                    	 <input type="text" class="mws-textinput" name="product_type"/>
                                        <!-- <select name="product_type">
                                        	<?php foreach($product_types as $product_type) { ?>
                                            <option value="<?php echo $product_type->type_name?>"><?php echo $product_type->type_name?></option>
                                            <!-- <option value="2">地道保健系列</option>
                                            <option value="3">参类产品系列</option>
                                            <option value="4">灵芝产品系列</option>
                                            <option value="5">鹿茸产品系列</option> -->
                                            <!-- <?php } ?>  -->
                                        <!-- </select> -->
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>是否时尚</label>
                                    <div class="mws-form-item small">
                                    	 <input type="text" class="mws-textinput" name="product_class"/>
                                ...
                                <div class="mws-form-row">
                                    <label>商品价格</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="product_price" />
                                    </div>
                                </div>   
                                <div class="mws-form-row">
                                    <label>库存量</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="product_stock" />
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>图片</label>
                                    <div class="mws-form-item small">
										  <input type="file" class="mws-textinput customfile-input" name="product_picture"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>商品描述</label>
                                    <div class="mws-form-item large">
                                        <textarea type="text" class="mws-textinput" style="width:466px; height:200px;"  name="product_content"></textarea>
                                    </div>
                                </div>
                                <!-- <div class="mws-form-row">
                                    <label>上架时间</label>
