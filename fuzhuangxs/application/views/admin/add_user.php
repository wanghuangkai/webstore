            ...
            <div class="container">
              ...
              <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body">
                        <form class="mws-form" action="<?php echo site_url('admin/back/add_user');?>" method="post">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label>用户姓名</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_name"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户密码</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_pwd"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户电话</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_tel"/>
                                    </div>
                                </div>
                                 <div class="mws-form-row">
                                    <label>用户邮箱</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_email"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户地址</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_address"/>
                                    </div>
                                </div>                              
