            ...
            <div class="container">
              ...
              <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span class="mws-i-24 i-list">用户信息填写</span>
                    </div>
                    <div class="mws-panel-body">
                        <form class="mws-form" action="<?php echo site_url('admin/back/edit_user');?>" method="post">
                            <div class="mws-form-inline">
                            	<input type="hidden" name='user_id' value="<?php echo $user->user_id?>" />
                                <div class="mws-form-row">
                                    <label>用户姓名</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_name" value="<?php echo $user->user_name?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户密码</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_pwd" value="<?php echo $user->passwd?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户电话</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_tel" value="<?php echo $user->tel?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户邮箱</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_email" value="<?php echo $user->email?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>用户地址</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="user_address" value="<?php echo $user->address?>"/>
                                    </div>
                                </div>                              
