            ...
            <div class="container">
              ...
              <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span class="mws-i-24 i-list">管理员信息</span>
                    </div>
                    <div class="mws-panel-body">
                        <form class="mws-form" action="<?php echo site_url('admin/back/edit_admin');?>" method="post">
                            <div class="mws-form-inline">
                            	<input type="hidden" name='user_id' value="<?php echo $admin->id?>" />
                                <div class="mws-form-row">
                                    <label>管理员用户名</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="admin_name" value="<?php echo $admin->admin_name?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>管理员密码</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="admin_pwd" value="<?php echo $admin->admin_pwd?>"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>管理员权限</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="permission" value="<?php echo $admin->permission?>"/>
                                    </div>
                                </div>
                            </div>
