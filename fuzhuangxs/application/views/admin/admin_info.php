            ...
            <div class="container">
      		...
      		<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-table-1" style="display: block; float: left;">所有管理员列表</span>
                    	<div id="templatemo_search">
			                <form action="<?php echo site_url("admin/back/get_search_admin");?>" method="post">
			                	<!-- <input   id="searchbutton" class="sub_btn" style="background: url()" /> -->
			                	<!-- <input type="submit" value="" style="float: right; width: 30px; height: 30px; border: none; margin-left: 6px; background: url(../../assets/images/search_bg_btn.png)"> -->
			                	<!-- <div><input type="submit" /></div> -->
			                	
			                  	<!-- <input type="text" placeholder="查询商品" name="search" class="txt_field" style="background: url(../assets/images/search_bg_btn.png)"/> -->
			                	<input type="submit" name="submit" value="查询"  id="searchbutton" title="Search" class="sub_btn" />
			                  	<input type="text" placeholder="查询" name="search" class="txt_field" />
			                </form>
			            </div>
                    </div>
                    <div id="BlogOpts" style="background:#eee;border:1px solid #ccc;margin:5px 0 10px 0;padding:3px 10px;color:#999;">
                    	<a href="<?php if($login_admin->permission==0) echo site_url("admin/back/add_admin_view");?>" style="text-decoration: none;"><img src="<?php echo site_url('assets/admin/images/add.png');?>" style="width: 15px; height: 15px;">添加</a>&nbsp;|
						...
						<a href="javascript:;" onclick="unselect_all();" style="text-decoration: none;"><img src="<?php echo site_url('assets/admin/cancel.png');?>" style="width: 15px; height: 15px;">取消</a>&nbsp;|
						...
						<a href="javascript:;" onclick="delete_sel()" style="text-decoration: none;"><img src="<?php if($login_admin->permission==0) echo site_url('assets/admin/images/delete.png');?>" style="width: 15px; height: 15px;">删除选中</a>
					 </div>
					 <!-- <li class="row_1">
                        ...
                        <table class="mws-table">
                            <thead>
                             ...
                             <tbody>
                             	...
                             	?>    
	                              <tr class="gradeX">
	                                 <td><input name="id" value="<?php echo $admin->id;?>" type="checkbox"></td>
	                                 <td><?php echo "$admin->admin_name"?></td>
	                                 <td><?php echo "$admin->admin_pwd"?></td>
	                                 <td><?php echo "$admin->permission"?></td>
	                                 <td><a href="<?php if($login_admin->permission==0) echo site_url("admin/back/edit_admin_view/".$admin->id);?>" style="text-decoration: none;"><img src="<?php echo site_url('assets/admin/images/edit.png');?>" style="width: 15px; height: 15px;">编辑</a>&nbsp;|
	                                 	<a href="<?php if($login_admin->permission==0) echo site_url("admin/back/delete_admin/".$admin->id);?>" style="text-decoration: none;"><img src="<?php echo site_url('assets/admin/images/delete.png');?>" style="width: 15px; height: 15px;">删除</a>&nbsp;
	                                 </td>
	                              </tr>
                                <?php } ?>
                            </tbody>
    ...
    <script type="text/javascript">
		...
		function delete_sel(){
			...
			if(ids.length > 0){
				...
				$.get("<?php echo site_url("admin/back/remove_admin")?>","id="+ids,function(html){
					location.reload();
				});
			}
			else {
