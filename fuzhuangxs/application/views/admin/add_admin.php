            ...
            <div class="container">
              ...
              <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body">
                        <form class="mws-form" action="<?php echo site_url('admin/back/add_admin');?>" method="post">
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label>管理员用户名</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="admin_name"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>管理员密码</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="admin_pwd"/>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label>管理员权限</label>
                                    <div class="mws-form-item small">
                                        <input type="text" class="mws-textinput" name="permission"/>
                                    </div>
                                </div>
                            </div>
