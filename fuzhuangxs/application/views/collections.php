        ...
        <div class="cart_table">
          <table class="data-table cart-table" id="shopping-cart-table" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <th class="align_center" width="6%">收藏时间</th>
              <th class="align_center" width="12%">用户名</th>
              <th class="align_center" width="10%">商品简介</th>
            ...
            foreach($collection as $coll)
            {
     		?>
            <tr>
              <td width="10%"><a href="<?php echo site_url('user/leisure_detail/'.$coll->p_id)?>"><img src="<?php echo site_url($coll->url);?>"/></a></td>
              <td class="align_left" width="44%"><a class="pr_name" href="#">商品名：<?php echo $coll->p_name;?>;&nbsp&nbsp商品id：<?php echo $coll->p_id;?></a><span class="pr_info"></span></td>
              <td class="align_center vline"><span class="price"><?php echo $coll->c_time;?></span></td>
              <td class="align_center vline"><span class="price"><?php echo $coll->user_name;?></span></td>
              <td class="align_center vline"><span class="price"><?php echo $coll->p_info?></span></td>
              <td class="align_center vline"><a href="<?php echo site_url('user/del_collection/'.$coll->id);?>" class="remove"></a></td>
            </tr>
            <?php
            }
            ?>
          ...
          <!-- <div class="totals">
            <table id="totals-table">
                ...
                <tr>
                  ...
                  <td class="align_right" style=""><span class="total">￥<?php echo $sum;?></span></td>
                </tr>                
            </table>
          </div> -->
        </div>
